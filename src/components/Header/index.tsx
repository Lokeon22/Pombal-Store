  ...
  return (
    <header className="w-full h-auto xl:h-40 border-b-4 border-blue-400">
      <div className="w-full xl:items-stretch max-w-[1300px] mx-auto my-0 py-3 lg:py-10 px-2 lg:px-4 flex-wrap">
        <Link href={"/"}>
          <h2 className="block lg:hidden font-medium text-xl text-center mb-2">
        ...
        <div className="flex items-center gap-2 lg:gap-3 xl:gap-5">
          ...
          <Link className="w-max" href={"/"}>
            <h2 className="w-max hidden font-medium lg:block text-xl xl:text-3xl">
              Pombal <strong className="text-blue-400">Store</strong>
            </h2>
          </Link>
        ...
        <ul className="hidden xl:flex items-center justify-center gap-10 mt-7 hover:[&>*:nth-child(odd)]:text-blue-400 hover:[&>*:nth-child(even)]:text-blue-400">
          <li className="hover:duration-300">
